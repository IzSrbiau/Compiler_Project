        ...
        btnAdd.addActionListener( new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (  tfWord.getText().length() > 0 && taMeaning.getText().length() > 0  ) {
                    Dic.add(tfWord.getText(), taMeaning.getText());
                    tfWord.setText("");
                    taMeaning.setText("");
                    tfWord.requestFocus();
                    JOptionPane.showMessageDialog( Add.this, "Added Word Successfully!","Add Word", JOptionPane.INFORMATION_MESSAGE);
                }
                else
                    JOptionPane.showMessageDialog( Add.this, "Please enter word and meaning!","Add Word", JOptionPane.ERROR_MESSAGE);
            }
        }
        );
